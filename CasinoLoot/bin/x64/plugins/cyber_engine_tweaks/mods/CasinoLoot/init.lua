...
local CasinoLootKeys = {
  "Items.CasinoLoot_SlashToken",
  "Items.CasinoLoot_BluntToken",
  "Items.CasinoLoot_ThrowToken",
  "Items.CasinoLoot_PistolToken",
  "Items.CasinoLoot_ShotgunToken",
  "Items.CasinoLoot_SniperToken",
  "Items.CasinoLoot_RifleToken",
  "Items.CasinoLoot_SMGToken"
}
